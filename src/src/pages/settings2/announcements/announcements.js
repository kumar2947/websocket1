  ...
  const accordionitems = [
    {
      title: (
        <>
          <div className="w-100 ">
            <div className="d-flex flex-row flex-lg-row px-3 my-2 align-items-lg-center flex-wrap settingsannouncements">
              <div className="my-1 col-12 Title">
                <div className="subtitle-color font-12 poppins-semibold pb-1">
                  Title
                </div>
                <div className="darktext font-12 poppins-semibold" >
              ...
              <div className="my-1 col-12 IsArchived">
                ...
                <div className="darktext font-12 poppins-semibold">No</div>
              </div>
              <div className="dividerdashed vertical mx-2 d-none d-lg-block"></div>
  ...
  return (
    <>
      <div className="mb-2 d-flex align-items-center bgcolor-primary px-2 py-1 whitetext border-radius1 ">
        <div className="d-flex align-items-center py-2"><h2 tabIndex={0} aria-label='Announcements' className="font-14 d-flex align-items-center"> <span className="icon-announcement font-12 pe-2"></span> Announcements</h2></div>
      ...
      {showAddPopup ? (
        <div className="settingsaddpopup w-100 my-2 border-radius whitebg d-inline-block bordered1">
          <div className="p-3 border-bottom1 ">
            <h4 className="m-0 p-0 d-inline-block font-15 montserratsemibold textcolor4 text-uppercase">
              <span tabIndex={0} aria-label="Add Announcements">
                Add Announcements
              </span>
            </h4>
          </div>
