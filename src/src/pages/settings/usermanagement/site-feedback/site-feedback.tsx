                                ...
                                <div className="d-flex">
                                    <div className='d-flex flex-column flex-md-row flex-nowrap w-100'>
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-10'>{poclist.nametitle}</span>
                                            <span>{poclist.name}</span>
                                        </div>
                                        <div className="dividerdashed vertical mx-2 mx-lg-3 d-none d-md-block"></div>
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-10'>{poclist.othertitle}</span>
                                            <span>{poclist.other}</span>
                                        </div>
                                        <div className="dividerdashed vertical mx-2 mx-lg-3 d-none d-md-block"></div>
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-10'>{poclist.descriptiontitle}</span>
                                            <span>{poclist.description}</span>
                                        </div>
                                        <div className="dividerdashed vertical mx-2 mx-lg-3 d-none d-md-block"></div>
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-10'>{poclist.attachmenttitle}</span>
                                            <span>{poclist.attachment}</span>
                                        </div>
                                        <div className="dividerdashed vertical mx-2 mx-lg-3 d-none d-md-block"></div>
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-10'>{poclist.modifiedtitle}</span>
