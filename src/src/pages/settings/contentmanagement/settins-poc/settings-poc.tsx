                ...
                <div className='row'>
                    ...
                    <div className='p-0 settings-main'>
                        ...
                        {pocitems.map(poclist =>
                            <div className="d-flex flex-column shadow card poppins-medium mb-2 p-2" key={addeditValue.name}>
                                <div className="d-flex">
                                    <div className='d-flex flex-column flex-md-row flex-nowrap w-100'>
                                        ...
                                        <div className="d-flex flex-column me-auto">
                                            <span className='subtitle-color1 font-12'>{poclist.phonenotitle}</span>
                                            <span>{poclist.phoneno}</span>
                                        </div>
                                        <div className="dividerdashed vertical mx-2 mx-lg-3 d-none d-md-block"></div>
                                        <div className="d-flex flex-column me-auto">
