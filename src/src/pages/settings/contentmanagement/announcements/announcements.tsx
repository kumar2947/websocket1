...
const Announcements = (props:any) => {
  ...
  const accordionitems = [
    {
      Title: 'How yyte do I find my Cross Orged LOA in DTS?',
      Category: 'DTS',
      'Is Archived': 'No',
      is_active: 'true',
    ...
    {
      Title: 'How do I find my Cross Orged LOA in DTS?',
  ...
  function acordioncontent (Desc:any, AttachedFileName:any, buttontext:any) {
    return (
      (<>
            <AddeditView />
            ...
            <div className='container' ref={elementRef}>
                <div className='row'>
                    <div className='mt-0 p-0 d-flex align-items-center'>
                        <h2 tabIndex={0} aria-label='Announcements'>Announcements</h2>
                        <Buttons
                            label="ADD"
                            aria-label="ADD"
                            icon="icon-add me-1"
                    ...
                    <div className='p-0 settings-main'>
                        ...
                        {<Accordions
                            ...
                            headerextras={[{ name: 'Title', classq: 'me-auto' }, { name: 'Category', classq: 'min-w-md-100 min-w-xl-175' }, { name: 'Is Archived', classq: 'text-nowrap maxfitcontent-lg' }]
                            }
