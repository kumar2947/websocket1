  ...
  return (
    <>
      ...
      <div className="mb-2 d-flex align-items-center bgcolor-primary px-2 py-1 whitetext border-radius1 ">
        <div className="d-flex align-items-center py-2"><h2 tabIndex={0} aria-label='Knowledge Articles' className="font-14 d-flex align-items-center"> <span className="icon-knowledgebase font-16 pe-2"></span>Knowledge Articles</h2></div>
